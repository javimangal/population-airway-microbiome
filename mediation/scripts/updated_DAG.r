...
Biofuel_exposure -> Smoking_binary
Biofuel_exposure -> year2pm25
Gender -> AMHI
...
Occupational_pollution -> Biofuel_exposure
Occupational_pollution -> SHS_binary
SHS_binary -> AMHI
SHS_binary -> Airway_disease
Smoking_binary -> AMHI
Smoking_binary -> Airway_disease
Smoking_binary -> SHS_binary
